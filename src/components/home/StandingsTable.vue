  ...
  <section class="py-16 bg-fcabl-dark-light">
    <div class="container mx-auto px-4">
      ...
      <div class="flex items-center justify-between mb-8">
        ...
        <router-link to="/standings" class="hidden sm:flex btn btn-outline btn-sm text-gray-300 border-2 border-gray-600 hover:bg-fcabl-accent hover:border-fcabl-accent hover:text-white">
          Full Standings
      ...
      <!-- Desktop Table -->
      <div class="hidden md:block overflow-x-auto bg-fcabl-dark rounded-lg shadow-xl">
          ...
          <tbody>
            ...
            >
              <td class="font-semibold">
                <span v-if="standing.rank === 1" class="text-fcabl-accent text-xl">
                  <font-awesome-icon :icon="['fas', 'trophy']" />
                </span>
                <span v-else class="text-gray-400">{{ standing.rank }}</span>
              </td>
              <td>
                <router-link 
                  :to="{ path: '/teams', query: { team_id: standing.team.id } }"
      ...
      <div class="mt-8 text-center sm:hidden">
        <router-link to="/standings" class="btn btn-outline text-gray-300 border-2 border-gray-600 hover:bg-fcabl-accent hover:border-fcabl-accent hover:text-white">
          Full Standings
          <font-awesome-icon :icon="['fas', 'chevron-right']" class="ml-2" />
        </router-link>
      </div>
