...
<template>
  <nav class="navbar bg-fcabl-dark-light shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4 flex items-center">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-center">
        <ul class="menu menu-horizontal px-1 text-lg font-medium">
          <li><router-link to="/" exact active-class="text-fcabl-accent bg-fcabl-dark/50 shadow-md ring-1 ring-fcabl-accent/30" class="text-gray-200 hover:text-white hover:bg-fcabl-dark/50">Home</router-link></li>
      ...
      <div class="hidden lg:flex gap-2 lg:flex-none">
        <template v-if="!authStore.isAuthenticated">
          <button @click="emit('openLogin')" class="btn btn-ghost btn-sm text-gray-300 hover:text-white hover:bg-fcabl-dark-light/50 ring-2 ring-gray-500 shadow-md hover:ring-gray-400">
    ...
    <div v-if="mobileMenuOpen" class="lg:hidden absolute top-full left-0 right-0 bg-fcabl-dark-light shadow-xl">
      <ul class="menu p-4">
        <li><router-link to="/" exact @click="toggleMobileMenu" active-class="text-fcabl-accent bg-fcabl-dark/50 font-semibold shadow-md ring-1 ring-fcabl-accent/30" class="text-gray-300">Home</router-link></li>
