...
import { standingsService, teamService } from "@/services/api";
import type { Standing, Team } from "@/types/game.types";
...
const calculateWinPercentage = (team: Team): string => {
    var winPct = team.wins / (team.wins + team.losses);
            ...
            <div class="container mx-auto px-4">
                <div class="text-center">
                    ...
                    <p class="text-gray-400 text-lg">
                        Full season standings for all teams
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="py-12">
            <div class="container mx-auto px-4">
                ...
                <div v-else>
                    <!-- Desktop Table -->
                    <div
                        class="hidden md:block overflow-x-auto bg-fcabl-dark-light rounded-lg shadow-xl"
                    >
                        <table class="table w-full">
                            <thead>
                                <tr class="border-b border-gray-700">
                                    ...
                                    <th class="text-gray-400 text-center">
                                        Win %
                                    </th>
                                    <th class="text-gray-400 text-center">
                                        PF
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td
                                        class="text-center font-semibold text-success text-lg"
                                    >
                                        {{ team.wins }}
                                    </td>
                                    <td
                                        class="text-center font-semibold text-error text-lg"
                                    >
                                        {{ team.losses }}
                                    </td>
                                    <td
                                        class="text-center font-semibold text-fcabl-accent text-lg"
                                    >
                                        {{ calculateWinPercentage(team) }}
                                    </td>
                                    <td
                                        class="text-center font-semibold text-gray-300"
                                    >
                                        {{ team.pointsFor }}
                                    </td>
                                    <td
                    ...
                    <div class="md:hidden space-y-4">
                        ...
                        >
                            <div class="card-body">
                                ...
                                <div
                                    class="grid grid-cols-3 gap-3 text-center mb-3"
                                >
                                    <div>
                                        <div
                                ...
                                <div
                                    class="grid grid-cols-3 gap-3 text-center pt-3 border-t border-gray-700"
                                >
                                    <div>
                                        <div
